...
while ~isDone(videoFR)
    ...
    [frame, sample] = videoFR(); %Чтение кадра с аудиосэмплом  
...
audioSV(length(audioSV) + 1:frameCounter * lengthAudiosample) = 0; %Это дополнение до целого числа кадров
